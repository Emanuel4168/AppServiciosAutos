...
//    public static final String SERVICE_RFC = "rfc";
    ...
    public static final String CREATE_TABLE_CARS = "CREATE TABLE "+CARS_TABLE+"("+CARS_PLATE+" TEXT PRIMARY KEY, " +CARS_TRADEMARK+" TEXT, " +CARS_MODEL+" TEXT, "+CARS_YEAR+" INTEGER)";
